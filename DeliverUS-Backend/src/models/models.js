...
import loadCommissionModel from './Commission.js'
...
const Commission = loadCommissionModel(sequelizeSession, Sequelize.DataTypes)

const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Commission }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Commission, sequelizeSession }
